                ...
                <GlassCard padding="p-5" className="flex flex-col gap-4">
                  ...
                  <div className="flex gap-2">
                    <input
                      ...
                      className="flex-1 h-12 bg-surface-container-low rounded-xl px-4 font-body text-sm font-light border-none focus:ring-2 focus:ring-primary-container focus:outline-none"
                    />
